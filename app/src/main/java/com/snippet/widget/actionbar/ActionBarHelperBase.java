...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    public void clearMenu(final Menu menu) {
        ...
        for (Integer id : mActionItemIds) {
            View menuItem = actionBarCompat.findViewById(id);
            actionBarCompat.removeView(menuItem);
        }
    ...
    private void setupActionBar() {
        ...
        SimpleMenuItem homeItem = new SimpleMenuItem(
                tempMenu, android.R.id.home, 0, mActivity.getTitle());
        homeItem.setIcon(mActivity.getResources().getIdentifier("ic_launcher", "drawable", mActivity.getPackageName()));
